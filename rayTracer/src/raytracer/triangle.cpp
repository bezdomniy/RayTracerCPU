    ...
    : Shape()
{
    ...
    this->p2 = p2;
    this->p3 = p3;
    this->n1 = glm::normalize(glm::cross(p3 - p1, p2 - p1));
...
void Triangle::intersectRay(Ray &ray, std::vector<Geometry::Intersection<Shape>> &intersections)
{
    ...
    glm::dvec3 dirCrossE2 = glm::cross(glm::dvec3(transformedRay.direction), e2);
...
{
    return normalToWorld(glm::dvec4(this->n1, 0.0));
}
