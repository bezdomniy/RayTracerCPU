...
int main(int argc, char const *argv[])
{
	...
	std::shared_ptr<Camera> camera = std::make_shared<Camera>(glm::vec4(0.f, 0.f, -5.f, 1.f),glm::vec4(0.f, 0.f, 1.f, 0.f),glm::vec4(0.f, 1.f, 0.f, 0.f), 100.f, 50.f, glm::radians(60.f));
