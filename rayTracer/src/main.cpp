...
int main(int argc, char const *argv[])
{
	...
	Sphere floor(0, glm::vec4(0.f,0.f,0.f, 1.f), 1.f);
	...
	std::shared_ptr<Material> material2 = std::make_shared<Material>(glm::vec3(0.5f,1.f,0.1f),ambient,diffuse,specular,shininess);
	std::shared_ptr<Material> material3 = std::make_shared<Material>(glm::vec3(1.f,0.8f,0.1f),ambient,diffuse,specular,shininess);
	std::shared_ptr<Material> materialFloor = std::make_shared<Material>(glm::vec3(1.f,0.9f,0.9f),ambient,diffuse,specular,shininess);
	...
	s3.transform = glm::translate(glm::mat4(1.f), glm::vec3(-1.5f, 0.33f, -0.75f));
	s3.transform *= glm::scale(glm::mat4(1.f), glm::vec3(0.33f,0.33f,0.33f));

	floor.transform *= glm::scale(glm::mat4(1.f), glm::vec3(10.f,0.01f,10.f));
