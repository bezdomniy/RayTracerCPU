...
bool Game::init(const char* title, int xpos, int ypos, bool fullscreen)
{
	...
	else
	{
		...
		else
		{
			...
			gameObjects["ogre1"] = GameObject(gSpriteSheet["ogre_run_anim"].first, gSpriteSheet["ogre_run_anim"].second);
			gameObjects["ogre2"] = GameObject(gSpriteSheet["ogre_run_anim"].first, gSpriteSheet["ogre_run_anim"].second);
...
bool Game::render()
{
	...
	gSpriteSheetTexture.render(window_width/2, window_height/2, gameObjects["ogre1"].currentSprite);
	gSpriteSheetTexture.render(window_width / 2  + 100, window_height / 2, gameObjects["ogre2"].currentSprite);
